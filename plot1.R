#Explorartory Data Analysys Project1 Plot1
...
#draw the plot
with(datedata, hist(as.numeric(Global_active_power),col='RED',xlab="Global Active Power (Kilowatts)" , main="Global Active Power"))
